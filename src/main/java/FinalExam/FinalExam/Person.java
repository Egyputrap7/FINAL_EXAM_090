...
@NamedQueries({
    ...
    @NamedQuery(name = "Person.findByTimestam", query = "SELECT p FROM Person p WHERE p.timestam = :timestam")})
public class Person implements Serializable {
    ...
    public Person(Integer id, int nik, String nama, Date tanggalLahir, byte[] foto, Date timestam) {
        this.id = id;
        this.nik = nik;
        this.nama = nama;
    ...
    public String toString() {
        return "FinalExam.FinalExam.Person[ id=" + id + " ]";
    }
